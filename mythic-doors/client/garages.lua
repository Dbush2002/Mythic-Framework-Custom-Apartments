function CreateGaragePolyZones()
    ...
    Polyzone.Create:Box('doors_vpd_bottom_left', vector3(-1075.18, -852.48, 4.88), 4.4, 13.4, {
        heading = 310,
        minZ = 3.68,
        maxZ = 9.05,
    }, {
        door_garage_id = 'vpd_bottom_left',
    })
    Polyzone.Create:Box('doors_vpd_bottom_right', vector3(-1071.15, -849.29, 4.87), 4.2, 12.0, {
        heading = 310,
        minZ = 3.63,
        maxZ = 9.05,
    }, {
        door_garage_id = 'vpd_bottom_right',
    })

    Polyzone.Create:Box('doors_vpd_upper_garage', vector3(-1121.93, -835.85, 13.34), 14.6, 9.4, {
        heading = 310,
        minZ = 11.05,
        maxZ = 17.35,
    }, {
        door_garage_id = 'vpd_upper_garage',
    })
    Polyzone.Create:Box('doors_vpd_bollards_enter', vector3(-1147.4, -847.19, 14.5), 11.2, 11.6, {
        heading = 307,
        minZ = 11.75,
        maxZ = 18.68,
    }, {
        door_garage_id = 'vpd_bollards_enter',
    })
    Polyzone.Create:Box('doors_vpd_back_fence', vector3(-1056.57, -875.98, 5.13), 7.4, 11.4, {
        heading = 302,
        minZ = 3.48,
        maxZ = 10.20,
    }, {
        door_garage_id = 'vpd_back_fence',
    })
