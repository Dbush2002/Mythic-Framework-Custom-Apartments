...
-- =====================================================
-- Dynamic Restriction Helpers (Apartment / Property Support)
-- =====================================================
...
local function _SyncRestriction(doorId)
    TriggerClientEvent('Doors:Client:UpdateRestriction', -1, doorId, _doorConfig[doorId] and _doorConfig[doorId].restricted or nil)
end
    ...
    SetLock = function(self, doorId, newState, doneDouble)
        ...
        if doorData then
            ...
            if newState ~= isLocked then
                ...
                -- Server-side hook for other resources (e.g., apartments)
